...
<template>
  <div id="panel" ref="panelH">
    <div class="inner" ref="innerH">
      <p class="panel-title">行政区/建成区OD分析</p>
      <div class="ctl-box">
        <TimeCtlPanel/>
        <AdminOdPanel :title="adminTitle"/>
      </div>
    </div>
    <PanelSaveComp/>
  </div>
...
<script>
  ...
  import AdminOdPanel from '../subComp/AdminOdPanel'
  import PanelSaveComp from '../subComp/PanelSaveComp'
  import personTripHandle_5 from '../../../service/workbench/personTripHandle_5'
  ...
  export default {
    ...
    mounted() {
      this.controller = new personTripHandle_5(this);
      this.$nextTick(() => {
    ...
    methods:{
      ...mapMutations(['updatePersonTrip5','updateLinkList','updateLinkId','updatePanelTime','updateDisplayTime','updateFlowRangeMax','updateFlowRangeMin',
