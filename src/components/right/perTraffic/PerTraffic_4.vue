...
<template>
  <div id="panel" ref="panelH">
    <div class="inner" ref="innerH">
      <p class="panel-title">职住平衡分析</p>
      <div class="ctl-box">
        <TimeCtlPanel/>
        <ResidencePanel :title="travelTitle"/>
      </div>
    </div>
    <PanelSaveComp/>
  </div>
...
<script>
  ...
  import ResidencePanel from '../subComp/ResidencePanel'
  import PanelSaveComp from '../subComp/PanelSaveComp'
  import personTripHandle_4 from '../../../service/workbench/personTripHandle_4'
  ...
  export default {
    ...
    mounted() {
      this.controller = new personTripHandle_4(this);
      this.$nextTick(() => {
    ...
    methods:{
      ...mapMutations(['updatePersonTrip4','updateLinkList','updateLinkId','updatePanelTime','updateDisplayTime','updateFlowRangeMax','updateFlowRangeMin',
