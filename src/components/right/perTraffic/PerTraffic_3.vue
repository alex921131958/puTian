...
<template>
  <div id="panel" ref="panelH">
    <div class="inner" ref="innerH">
      <p class="panel-title">出行特征分析</p>
      <div class="ctl-box">
        <TimeCtlPanel/>
        <TravelCharacteristicsPanel :title="travelTitle"/>
      </div>
    </div>
    <PanelSaveComp/>
  </div>
...
<script>
  ...
  import TravelCharacteristicsPanel from '../subComp/TravelCharacteristicsPanel'
  import personTripHandle_3 from '../../../service/workbench/personTripHandle_3'
  ...
  export default {
    ...
    mounted() {
      this.controller = new personTripHandle_3(this);
      this.$nextTick(() => {
    ...
    methods:{
      ...mapMutations(['updatePersonTrip3','updateLinkList','updateLinkId','updatePanelTime','updateDisplayTime','updateFlowRangeMax','updateFlowRangeMin',
