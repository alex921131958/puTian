    ...
    <transition name="fade">
      <div v-if="isPanelOpen">
        ...
        <p class="list">
          ...
          <span class="response"><RatioSlider :bufferRatio="buffer_width['cmnTraffic-3']" ref="ratioSlider" @ratioChange="slideChange"/></span>
        ...
        <!--<div class="tip-panel">-->
          ...
          <!--<p>当在道路选择中仅选择一个路段时，分析面板将显示途经该路段的各条公交线路的流量构成情况。</p>-->
        <!--</div>-->
      </div>
    </transition>
  </div>
    ...
    methods: {
      ...
      setFlowParam(menuId){
        if(menuId === "cmnTraffic-3"){
          ...
          if(this.cmn_traffic_3.roadtype==='line' && this.cmn_traffic_3.links && this.cmn_traffic_3.links!==''){
